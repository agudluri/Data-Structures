public interface CollectionInterface<E> {
	 ...
	 * 
	 * @return true - if this data structure is at its capacity; false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return the number of elements currently resident in this data structure.
	 */
	public int size();
	 ...
	 *            provide an order on how the element is added to the
	 *            collection.
	 */
